...
#define FFP_MSG_ERROR_RTMP_URL_NOT_FOUND    412
...
#define FFP_PROP_VIDEO_RECORD_START                     11000
#define FFP_PROP_VIDEO_RECORD_END                       11001
#define FFP_PROP_VIDEO_RECORD_ERROR                     11002
