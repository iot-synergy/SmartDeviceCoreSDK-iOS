...
public extension UIImage {
     ...
     */
    convenience init(gifName: String, for aClass: AnyClass = A4xBaseResource.self) {
        self.init()
        setGif(gifName, levelOfIntegrity: defaultLevelOfIntegrity, for: aClass)
    }
    ...
    /**
     ...
     - Parameter levelOfIntegrity: 0 to 1, 1 meaning no frame skipping
     */
    convenience init(gifName: String, levelOfIntegrity: Float, for aClass: AnyClass = A4xBaseResource.self) {
        self.init()
        setGif(gifName, levelOfIntegrity: levelOfIntegrity, for: aClass)
    }
     ...
     */
    func setGif(_ name: String, for aClass: AnyClass = A4xBaseResource.self) {
        setGif(name, levelOfIntegrity: defaultLevelOfIntegrity, for: aClass)
    }
    ...
    /**
     ...
     - Parameter levelOfIntegrity: 0 to 1, 1 meaning no frame skipping
     */
    func setGif(_ name: String, levelOfIntegrity: Float, for aClass: AnyClass = A4xBaseResource.self) {
        
        if let url = a4xBaseBundle(for: aClass).url(forResource: name, withExtension: name.getPathExtension() == "gif" ? "" : "gif"), let data = try? Data(contentsOf: url) {
