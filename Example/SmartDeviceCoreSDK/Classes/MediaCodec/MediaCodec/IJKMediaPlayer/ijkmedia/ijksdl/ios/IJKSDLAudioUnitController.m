...
- (id)initWithAudioSpec:(const SDL_AudioSpec *)aSpec
{
    ...
    if (self) {
        ...
        NSLog(@"IJKSDLAudioUnitController.m: initWithAudioSpec in");
        ...
        NSLog(@"IJKSDLAudioUnitController.m: initWithAudioSpec out");
    }
    return self;
}
...
- (void)play
{
    ...
    _isPaused = NO;
    NSError *error = nil;
    NSLog(@"IJKSDLAudioUnitController.m: play in");
...
- (void)pause
{
    if (!_auUnit)
        return;
    NSLog(@"IJKSDLAudioUnitController.m: pause in");
    
    _isPaused = YES;
    OSStatus status = AudioOutputUnitStop(_auUnit);
    
    NSLog(@"IJKSDLAudioUnitController.m: pause out");
    if (status != noErr)
...
- (void)flush
{
    ...
    NSLog(@"IJKSDLAudioUnitController.m: flush in");
...
- (void)stop
{
    ...
    NSLog(@"IJKSDLAudioUnitController.m: stop in");
    OSStatus status = AudioOutputUnitStop(_auUnit);
    
    NSLog(@"IJKSDLAudioUnitController.m: stop out");
    if (status != noErr)
...
- (void)close
{
    ...
    NSLog(@"IJKSDLAudioUnitController.m: close in");
    ...
    NSLog(@"IJKSDLAudioUnitController.m: close out");
    _auUnit = NULL;
}
