...
#define FFMPEG_CONFIGURATION "--enable-openssl --enable-nonfree --enable-runtime-cpudetect --disable-gray --disable-swscale-alpha --disable-programs --disable-ffmpeg --disable-ffplay --disable-ffprobe --disable-ffserver --disable-doc --disable-htmlpages --disable-manpages --disable-podpages --disable-txtpages --disable-avdevice --enable-avcodec --enable-avformat --enable-avutil --enable-swresample --enable-swscale --disable-postproc --enable-avfilter --enable-network --disable-d3d11va --disable-dxva2 --disable-vaapi --disable-vda --disable-vdpau --disable-videotoolbox --disable-encoders --enable-encoder=png --disable-decoders --enable-decoder=aac --enable-decoder=aac_latm --enable-decoder=flv --enable-decoder=h264 --enable-decoder='mp3*' --enable-decoder=flac --enable-decoder=hevc --disable-hwaccels --disable-muxers --enable-muxer=mp4 --disable-demuxers --enable-demuxer=aac --enable-demuxer=concat --enable-demuxer=data --enable-demuxer=flv --enable-demuxer=hls --enable-demuxer=live_flv --enable-demuxer=mov --enable-demuxer=mp3 --enable-demuxer=mpegps --enable-demuxer=mpegts --enable-demuxer=mpegvideo --enable-demuxer=flac --enable-demuxer=hevc --enable-demuxer=webm_dash_manifest --enable-demuxer=h264 --enable-demuxer=rtsp --enable-demuxer=sdp --enable-demuxer=rtp --disable-parsers --enable-parser=aac --enable-parser=aac_latm --enable-parser=h264 --enable-parser=flac --enable-parser=hevc --enable-parser=mpeg4video --enable-parser=mpegvideo --enable-bsfs --disable-bsf=chomp --disable-bsf=dca_core --disable-bsf=dump_extradata --disable-bsf=imx_dump_header --disable-bsf=mjpeg2jpeg --disable-bsf=mjpega_dump_header --disable-bsf=mov2textsub --disable-bsf=mp3_header_decompress --disable-bsf=mpeg4_unpack_bframes --disable-bsf=noise --disable-bsf=remove_extradata --disable-bsf=text2movsub --disable-bsf=vp9_superframe --enable-protocols --enable-protocol=async --disable-protocol=bluray --disable-protocol=concat --disable-protocol=crypto --enable-protocol=ffrtmpcrypt --enable-protocol=ffrtmphttp --disable-protocol=gopher --disable-protocol=icecast --disable-protocol='librtmp*' --disable-protocol=libssh --disable-protocol=md5 --disable-protocol=mmsh --disable-protocol=mmst --disable-protocol='rtmp*' --enable-protocol=rtmp --enable-protocol=rtmpt --enable-protocol=rtmps --enable-protocol=tls --enable-protocol=rtp --disable-protocol=sctp --disable-protocol=srtp --disable-protocol=subfile --disable-protocol=unix --enable-protocol=tcp --enable-protocol=udp --enable-protocol=file --enable-protocol=hls --disable-devices --disable-filters --enable-filter=aresample --enable-filter=scale --disable-iconv --disable-audiotoolbox --disable-videotoolbox --disable-linux-perf --disable-bzlib --enable-filter=aevalsrc --enable-filter=aresample --enable-filter=highpass --enable-filter=lowpass --enable-openssl --enable-nonfree --enable-filter=afftdn --enable-filter=bandreject --enable-filter=equalizer --enable-filter=firequalizer --enable-filter=afftfilt --enable-protocol=rtmps --enable-protocol=tls --enable-cross-compile --disable-stripping --arch=arm64 --target-os=darwin --enable-static --disable-shared --enable-pic --enable-neon --enable-optimizations --enable-debug --enable-small --prefix=/Users/mac/Downloads/ijk/ios/build/ffmpeg-arm64/output --enable-openssl --cc='xcrun -sdk iphoneos clang' --extra-cflags=' -arch arm64 -miphoneos-version-min=7.0 -fembed-bitcode -I/Users/mac/Downloads/ijk/ios/build/openssl-arm64/output/include' --extra-cxxflags=' -arch arm64 -miphoneos-version-min=7.0 -fembed-bitcode -I/Users/mac/Downloads/ijk/ios/build/openssl-arm64/output/include' --extra-ldflags=' -arch arm64 -miphoneos-version-min=7.0 -fembed-bitcode -arch arm64 -miphoneos-version-min=7.0 -fembed-bitcode -I/Users/mac/Downloads/ijk/ios/build/openssl-arm64/output/include -L/Users/mac/Downloads/ijk/ios/build/openssl-arm64/output/lib -lssl -lcrypto'"
#define FFMPEG_LICENSE "nonfree and unredistributable"
#define CONFIG_THIS_YEAR 2017
#define FFMPEG_DATADIR "/Users/mac/Downloads/ijk/ios/build/ffmpeg-arm64/output/share/ffmpeg"
#define AVCONV_DATADIR "/Users/mac/Downloads/ijk/ios/build/ffmpeg-arm64/output/share/ffmpeg"
