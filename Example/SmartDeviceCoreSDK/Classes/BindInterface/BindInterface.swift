...
public protocol BindInterface {
    ...
    func pushBindViewController(isAPMode: Bool, bindFromType: BindFromTypeEnum, navigationController: UINavigationController?)
    ...
    func presentBindViewController(isAPMode: Bool, bindFromType: BindFromTypeEnum, navigationController: UINavigationController?)
