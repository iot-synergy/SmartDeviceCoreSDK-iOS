...
#ifdef A4X_RTC
/** start/stop local audio record*/
- (void)startLocalAudioRecord:(int(^)(const int16_t *buffer,int bufferSize))localCallBack;
- (void)stopLocalAudioRecord;
/** playout remote audio data record*/
- (void)startPlayoutAudioRecord:(int(^)(const int16_t *buffer,int bufferSize))remoteCallBack;
/** stop playout audio record*/
- (void)stopPlayoutAudioRecord;
/** pause audio playout*/
- (void)pausePlayout:(BOOL)playing;
#endif
