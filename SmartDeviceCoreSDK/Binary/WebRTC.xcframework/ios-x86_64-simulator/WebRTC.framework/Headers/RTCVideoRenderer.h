...
#ifdef A4X_RTC
@class RTC_OBJC_TYPE(RTCEncodedImage);

RTC_OBJC_EXPORT
@protocol RTC_OBJC_TYPE
(RTCEncodeVideoSink)<NSObject>

/** encode video frame to export. */
- (void)onEncodeFrame:(nullable RTC_OBJC_TYPE(RTCEncodedImage) *)frame;
