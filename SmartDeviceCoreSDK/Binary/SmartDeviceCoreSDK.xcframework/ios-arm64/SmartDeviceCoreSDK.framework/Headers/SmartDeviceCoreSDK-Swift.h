...
@property (nonatomic, strong) id <BaseAdapterProtocol> _Nullable baseAdapter;
@property (nonatomic) BOOL isDoorBellLive;
@property (nonatomic) BOOL isVoipAnswerCall;
...
@property (nonatomic) BOOL enableLiveChat;
@end
...
enum XCGLoggerLevel : NSInteger;

SWIFT_PROTOCOL("_TtP18SmartDeviceCoreSDK19BaseAdapterProtocol_")
@protocol BaseAdapterProtocol
- (NSString * _Nonnull)getLocalStringWithKey:(NSString * _Nonnull)key param:(NSArray<NSString *> * _Nonnull)param SWIFT_WARN_UNUSED_RESULT;
- (void)vCommonLogError:(SWIFT_NOESCAPE id _Nullable (^ _Nonnull)(void))closure;
- (void)vLiveLogWithLevel:(enum XCGLoggerLevel)level :(SWIFT_NOESCAPE id _Nullable (^ _Nonnull)(void))closure;
- (void)clearResultFileWithUrl:(NSURL * _Nonnull)url;
...
- (void)queryUserActivityZoneOnSuccess:(void (^ _Nonnull)(NSInteger, NSString * _Nonnull, NSArray<ZoneBean *> * _Nullable))onSuccess onFail:(void (^ _Nonnull)(NSInteger, NSString * _Nonnull))onFail;
...
typedef SWIFT_ENUM(NSInteger, XCGLoggerLevel, open) {
  XCGLoggerLevelVerbose = 0,
  XCGLoggerLevelDebug = 1,
  XCGLoggerLevelInfo = 2,
  XCGLoggerLevelNotice = 3,
  XCGLoggerLevelWarning = 4,
  XCGLoggerLevelError = 5,
  XCGLoggerLevelSevere = 6,
  XCGLoggerLevelAlert = 7,
  XCGLoggerLevelEmergency = 8,
  XCGLoggerLevelNone = 9,
};
